 ...
 * ASSIGNMENT: CO-3 Assignment 2(b) - Noisy Stop-n-Wait Protocol - Receiver
 ****************************************************************************************/

/****************************************************************************************
 * COMPILATION: gcc noisystopnwaitReceiver.c -o noisystopnwaitReceiver
 * EXECUTION: ./noisystopnwaitReceiver
 ***************************************************************************************/
