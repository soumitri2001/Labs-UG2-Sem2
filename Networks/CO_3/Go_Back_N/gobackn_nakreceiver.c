 ...
 * ASSIGNMENT: CO-3 Assignment 3(b) - Go-Back-N Negative Acknowledgement Protocol - Receiver
 ****************************************************************************************/

/****************************************************************************************
 * COMPILATION: gcc gobackn_nakreceiver.c -o nak_receiver
 * EXECUTION: ./nak_receiver
 ***************************************************************************************/
